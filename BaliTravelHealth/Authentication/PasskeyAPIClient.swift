...
/// Draft server contract for WebAuthn / Passkey flows.
/// The production traveler Gateway does not expose these endpoints yet.
///
/// Two endpoints, both POST JSON:
///
/// 1. `POST /auth/passkey/begin`
...
struct PasskeyAPIClient: Sendable {
    ...
    var baseURL: URL = BaliAPI.url("auth/passkey")
